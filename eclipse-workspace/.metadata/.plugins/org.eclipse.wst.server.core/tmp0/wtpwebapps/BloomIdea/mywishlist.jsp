                            ...
                            <div class="col-md-7">
                                <div class="carousel-content">
                                    ...
                                    <div class="animation animated-item-2">
                                        Every new computer thats brought home from the store has an operating system installed onto it.
                                    </div>
             ...
             %>
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap fadeInDown">
                        <div class="pull-left">
                            <img class="img-responsive" src="upload/<%=s.getImage()%>" width="200px" height="200px">
                   ...
                   <a href="remove_from_wishlist.jsp?wid=<%=w.getId()%>"><input type="button"  name="action" value="Remove from Wishlist"></a>
                    <a href="cartlist.jsp?uid=<%=u.getId()%>&sid=<%=s.getId()%>"><input type="button"  name="action" value="Add to Cartlist"></a>
