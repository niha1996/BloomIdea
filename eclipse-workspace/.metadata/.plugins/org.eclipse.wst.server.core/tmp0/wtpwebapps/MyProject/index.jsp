						...
						<div class="right-content">
							<ul class="list-main">
								...
								<%
										...
										{
									%>
											<li><i class="ti-power-off"></i><a href="logout.jsp">Logout <%=u.getFname() %></a></li>	
									<%	
										}
										else
										{
									%>
											...
											<li><i class="ti-power-off"></i><a href="signup.jsp">Sign Up</a></li>
									<%		
										}
									%>
							</ul>
												...
												<div class="single-product">
													<div class="product-img">
														<a href="product-details.jsp">
															<img class="default-img" src="upload/<%=p.getImage() %>" style="width: 200px;height: 200px;" alt="#">
															<img class="hover-img" src="https://via.placeholder.com/550x750" alt="#">
														</a>
														<div class="button-head">
															<div class="product-action">
																<a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
																<a title="Wishlist" href="add_to_wishlist.jsp?uid=<%=u.getId()%>&pid=<%=p.getId()%>"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
													...
													<div class="product-content">
														<h3><a href="product-details.jsp"><%=p.getCname() %></a></h3>
