												...
												<div class="single-product">
													<div class="product-img">
														<a href="product-details.jsp?id=<%=p.getId()%>"> <img
															class="default-img" src="upload/<%=p.getImage()%>"
															alt="#" style="width: 400px; height: 400px;"> <img
															class="hover-img" src="upload/<%=p.getImage()%>" alt="#"
															style="width: 400px; height: 400px;">
														</a>
														<div class="button-head">
															<div class="product-action">
																<a title="Quick View" href="edit_product.jsp?id=<%=p.getId()%>"><i class=" ti-eye"></i><span>Edit Product
																		</span></a>
																<a title="Quick View" href="delete_product.jsp?id=<%=p.getId()%>"><i class=" ti-eye"></i><span>Delete Product
																		</span></a> 
													...
													<div class="product-content">
														<h3>
															<a href="product-details.jsp"><%=p.getCname()%></a>
														</h3>
														<div class="product-price">
															<span><%=p.getMname()%></span>
														</div>
														<div class="product-price">
															<span><%=p.getPrice()%></span>
														</div>
														<div class="product-price">
															<span><%=p.getSpecification()%></span>
														</div>
													</div>
												</div>
											</div>
