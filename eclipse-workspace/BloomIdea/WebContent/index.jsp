                ...
                <div class="features">
                    ...
                    <div class="col-md-3 col-sm-4 fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2>Cheap</h2>
                            <p>Okay, you have decided you want to make money with Affiliate</p>
                        </div>
                    </div>
                    <!--/.col-md-3-->
                    <div class="col-md-3 col-sm-4 fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
             ...
             %>
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap fadeInDown">
                        <div class="pull-left">
                        <a href="wishlist.jsp?sid=<%=s.getId()%>&uid=<%=u.getId()%>">
                ...
                <a href="cartlist.jsp?sid=<%=s.getId()%>&uid=<%=u.getId()%>">
                <input type="button"  name="action" value="Add to Cartlist"></a>
                   </div> 
